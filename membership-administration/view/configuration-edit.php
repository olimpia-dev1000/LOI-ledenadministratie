...
<section class="mt-4 pl-72 py-8 pr-4">
    ...
    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
        <div class="grid grid-cols-2 mb-8 gap-6 w-3/6 mx-auto">
            <input type="text" name="description" id="description" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Type" value="<?php echo $entity['description'] ?? null; ?>" required>
